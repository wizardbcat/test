		...
		<div class="row">
			...
			<div class="col-md-3">
				<div class="list-group">
					...
					<a href="${pageContext.request.contextPath}/category-add.jsp" class="list-group-item text-center ">新增学生</a>
					<a href="${pageContext.request.contextPath}/layout-update.jsp" class="list-group-item text-center active">修改学生信息</a>
					...
					<div class="panel-body">
						<form action="category" method="post" class="form-horizontal" role="form">
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" name="c_name" value="${param.c_name}" class="form-control" placeholder="姓名">
								</div>
								<div class="col-sm-5">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" name="place"  value="${param.place}" class="form-control" placeholder="地址">
								</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" name="type"  value="${param.type}" class="form-control" placeholder="专业">
								</div>
								<input type="hidden" name="c_id" value="${param.c_id}">
								<div class="col-sm-5">
